...
import { formatRelativeTime, isSensorOnline } from "@/lib/utils";
import type { Sensor } from "@/types/sensor";

interface AdminGoogleSensorMapProps {
  sensors: Sensor[];
}
          ...
          infoWindow.setContent(
            `
              <div style="min-width:180px;font-family:Inter,Arial,sans-serif;padding:2px 0;">
                ...
                <p style="font-size:12px;margin:0 0 4px;color:#334155;">Ketinggian Air: <strong>${sensor.hasWaterLevelData ? `${sensor.lastLevelCm} cm` : 'Menunggu Data'}</strong></p>
