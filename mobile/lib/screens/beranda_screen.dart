...
class BerandaScreen extends StatelessWidget {
  ...
  onNavigate; // 0=Beranda,1=Dashboard,2=Status,3=Darurat,4=Edukasi
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Color(0xFF1E3A8A),
            Color(0xFF0F172A),
          ], // Gradasi Navy Premium khusus Admin
        ),
      ),
      child: SafeArea(
        child: Padding(
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: () => navIndexNotifier.value =
                          1, // Pindah ke tab Data Sensor
    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: const Color(
            0xFFFFF1F2,
          ), // Box merah tipis penanda aksi darurat
          borderRadius: BorderRadius.circular(12),
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () => navIndexNotifier.value =
                  3, // Pindah langsung ke menu siaran darurat
              style: ElevatedButton.styleFrom(
...
class _StatsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final stats = [
      {
        'value': '${adminProvider.onlineSensorsCount}',
        'label': 'Sensor Aktif',
        'icon': Icons.sensors,
      },
      {'value': '24/7', 'label': 'Monitoring', 'icon': Icons.access_time},
      {
        'value': '${adminProvider.warningCount + adminProvider.dangerCount}',
        'label': 'Alert Aktif',
        'icon': Icons.notifications_active,
      },
    ...
    final features = [
      {
        ...
        'desc':
            'Pantau ketinggian air, curah hujan, dan kecepatan arus sungai secara langsung.',
      ...
      },
      {
        ...
        'desc':
            'Notifikasi dini dikirim ke masyarakat ketika level air melewati batas aman.',
        'color': AppTheme.statusWaspada,
      },
      {
        'icon': Icons.map,
        ...
        'desc':
            'Visualisasi lokasi sensor, zona risiko, dan titik evakuasi terdekat.',
      ...
      },
      {
        ...
        'desc':
            'One-click call ke BPBD, Basarnas, dan layanan darurat lainnya.',
    ...
    final steps = [
      {
        ...
        'desc':
            'Sensor IoT mengukur ketinggian air, curah hujan, dan arus sungai secara real-time setiap menit.',
      },
      {
        'title': 'Sistem Menganalisis',
        'desc':
            'Data dikirim ke server dan dianalisis untuk menentukan level status berdasarkan ambang batas.',
      },
      {
        'title': 'Alert Dikirim',
        'desc':
            'Jika status meningkat, notifikasi otomatis dikirim ke admin dan masyarakat sekitar.',
      },
      {
        'title': 'Tindakan Cepat',
        'desc':
            'Masyarakat mengakses panduan darurat dan menghubungi layanan emergency via satu tombol.',
      },
    ];
